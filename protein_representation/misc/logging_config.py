...
def setup_logger(name: str = "misc", level: int = logging.INFO, enable: bool = True) -> logging.Logger:
    """
    ...
    file_handler = logging.FileHandler(f"{base_log_dir}/misc.log")
